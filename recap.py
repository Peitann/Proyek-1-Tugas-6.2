...
def summarize_expenses_daily(expenses, budget):
    ...
    print(f"💵 Total Spent Today: Rp.{total_spent:.2f}")
    print(f"✅ Budget Remaining Today: Rp.{remaining_budget:.2f}")
...
def summarize_expenses_weekly(expenses, budget):
    ...
    print(f"💵 Total Spent This Week: Rp.{total_spent:.2f}")
    print(f"✅ Budget Remaining This Week: Rp.{remaining_budget:.2f}")
    print(f"📅 Remaining Days This Week: {remaining_days}")
    print(f"👉 Budget Per Day This Week: Rp.{weekly_budget:.2f}")
